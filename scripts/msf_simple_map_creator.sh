...
function poses_interpolation() {
  ...
  /apollo_workspace/bazel-bin/modules/localization/msf/poses_interpolator \
...
function create_lossless_map() {
  /apollo_workspace/bazel-bin/modules/localization/msf/lossless_map_creator \
...
function create_lossy_map() {
  /apollo_workspace/bazel-bin/modules/localization/msf/lossless_map_to_lossy_map \
