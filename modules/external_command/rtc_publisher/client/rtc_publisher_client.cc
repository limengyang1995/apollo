...
public:
    RtcPublisherClient(std::shared_ptr<Channel> channel) : stub_(Greeter::NewStub(channel)) {}
...
int main(int argc, char** argv) {
    ...
    RtcPublisherClient rtc_client(grpc::CreateChannel(target_str, grpc::InsecureChannelCredentials()));
    std::string user("world");
    std::string reply = rtc_client.Create(user);
