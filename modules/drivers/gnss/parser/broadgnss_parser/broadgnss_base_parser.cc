...
void BroadGnssBaseParser::FillIns() {
  ...
  ins_.mutable_euler_angles()->set_z((90 - (broadgnss_message_.heading >= 180 ? 
    broadgnss_message_.heading - 360: broadgnss_message_.heading ))* DEG_TO_RAD);
  //ins_.mutable_euler_angles()->set_z((180 - (broadgnss_message_.heading >= 180 ? 
  //  broadgnss_message_.heading - 360: broadgnss_message_.heading ))* DEG_TO_RAD);
  //ins_.mutable_euler_angles()->set_z((360 - broadgnss_message_.heading < 180 ? 
   // 360 - broadgnss_message_.heading : - broadgnss_message_.heading)* DEG_TO_RAD);
