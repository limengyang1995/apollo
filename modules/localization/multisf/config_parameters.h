...
public:
    ...
    void LoadParameters(const std::string &config_file_path) {
        try {
            ...
            vel_x_std_ = config_node["vel_x_std"].as<double>();
            vel_y_std_ = config_node["vel_y_std"].as<double>();
            vel_z_std_ = config_node["vel_z_std"].as<double>();

            gnss_vel_x_std_ = config_node["gnss_vel_x_std"].as<double>();
            gnss_vel_y_std_ = config_node["gnss_vel_y_std"].as<double>();
            gnss_vel_z_std_ = config_node["gnss_vel_z_std"].as<double>();

            gnss_q_x_std_ = config_node["gnss_q_x_std"].as<double>();
            gnss_q_y_std_ = config_node["gnss_q_y_std"].as<double>();
            gnss_q_z_std_ = config_node["gnss_q_z_std"].as<double>();

            lidar_position_x_std_ = config_node["lidar_position_x_std"].as<double>();
            lidar_position_y_std_ = config_node["lidar_position_y_std"].as<double>();
            lidar_position_z_std_ = config_node["lidar_position_z_std"].as<double>();
            lidar_q_x_std_ = config_node["lidar_q_x_std"].as<double>();
            lidar_q_y_std_ = config_node["lidar_q_y_std"].as<double>();
            lidar_q_z_std_ = config_node["lidar_q_z_std"].as<double>();
...
public:
    ...
    double gnss_vel_x_std_{};
    double gnss_vel_y_std_{};
    double gnss_vel_z_std_{};

    double gnss_q_x_std_{};
    double gnss_q_y_std_{};
    double gnss_q_z_std_{};

    double lidar_position_x_std_{};
    double lidar_position_y_std_{};
    double lidar_position_z_std_{};
    double lidar_q_x_std_{};
    double lidar_q_y_std_{};
    double lidar_q_z_std_{};
