...
template <typename PointTarget, typename PointSource>
void LsqRegistration<PointTarget, PointSource>::getFinal_transformation(Eigen::Matrix4f &final_transformation){
...
// 显式实例化
template class LsqRegistration<pcl::PointXYZ, pcl::PointXYZ>; // 根据需要实例化类型
}  // namespace fast_gicp