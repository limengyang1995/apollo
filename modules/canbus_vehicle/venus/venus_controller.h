...
class VenusController final : public VehicleController<::apollo::canbus::Venus> {
 public:

  VenusController() {};

  virtual ~VenusController();

  ::apollo::common::ErrorCode Init(
      const VehicleParameter& params,
      CanSender<::apollo::canbus::Venus> *const can_sender,
      MessageManager<::apollo::canbus::Venus> *const message_manager) override;
