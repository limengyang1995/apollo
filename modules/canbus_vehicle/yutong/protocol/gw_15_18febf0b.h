...
class Gw1518febf0b : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    double longitudinal_velocity(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double fl_wheel_speed(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double fr_wheel_speed(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double rl_wheel_speed(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double rr_wheel_speed(const std::uint8_t* bytes, const int32_t length) const;
};
