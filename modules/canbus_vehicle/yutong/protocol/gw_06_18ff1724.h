...
class Gw0618ff1724 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    Gw_06_18ff1724::Autohold_status_indicatorType autohold_status_indicator(const std::uint8_t* bytes, const int32_t length) const;
};
