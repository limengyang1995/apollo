...
class Gw0818ff1424 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    Gw_08_18ff1424::Electronic_parking_stateType electronic_parking_state(const std::uint8_t* bytes, const int32_t length) const;
};
