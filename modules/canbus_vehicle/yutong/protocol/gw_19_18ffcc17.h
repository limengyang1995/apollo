...
class Gw1918ffcc17 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    Gw_19_18ffcc17::Feedback_slow_handle_gearType feedback_slow_handle_gear(const std::uint8_t* bytes, const int32_t length) const;
};
