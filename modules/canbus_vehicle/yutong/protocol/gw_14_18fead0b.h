...
class Gw1418fead0b : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    double fl_brake_pressure(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double fr_brake_pressure(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double rl_brake_pressure(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double rr_brake_pressure(const std::uint8_t* bytes, const int32_t length) const;
};
