...
class Gw0418ff0824 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    Gw_04_18ff0824::State_of_vehicleType state_of_vehicle(const std::uint8_t* bytes, const int32_t length) const;
};
