...
class Gw1819fff103 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    Gw_18_19fff103::Fault_codeType fault_code(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Gw_18_19fff103::Level_of_failureType level_of_failure(const std::uint8_t* bytes, const int32_t length) const;
};
