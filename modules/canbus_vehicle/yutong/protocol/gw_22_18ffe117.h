...
class Gw2218ffe117 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    Gw_22_18ffe117::Small_light_statusType small_light_status(const std::uint8_t* bytes, const int32_t length) const;
};
