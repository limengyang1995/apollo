...
class Gw1318ff32f4 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    int single_cell_maxtemp(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int single_cell_mintemp(const std::uint8_t* bytes, const int32_t length) const;
};
