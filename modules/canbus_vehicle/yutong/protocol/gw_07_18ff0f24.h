...
class Gw0718ff0f24 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
    ...
    Gw_07_18ff0f24::Start_ignitionType start_ignition(const std::uint8_t* bytes, const int32_t length) const;
};
