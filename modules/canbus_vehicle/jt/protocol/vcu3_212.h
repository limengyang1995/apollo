...
class Vcu3212 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::Jt> {
 public:
 ...
 private:
    ...
    int vcu3_throttlevoltage(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_mainswitchType vcu3_mainswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_increasespeedswitchType vcu3_increasespeedswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_increasedistanceswitchType vcu3_increasedistanceswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_decreasespeedswitchType vcu3_decreasespeedswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_decreasedistanceswitchType vcu3_decreasedistanceswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_cancelswitchType vcu3_cancelswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_gearsecuritybuttonType vcu3_gearsecuritybutton(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_gearparkbuttonType vcu3_gearparkbutton(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_gearleverpositionType vcu3_gearleverposition(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_epbswitchType vcu3_epbswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double vcu3_vacuumpressure(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int vcu3_livecounter(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_leverinfoType vcu3_leverinfo(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_epbstatusType vcu3_epbstatus(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int vcu3_checksum(const std::uint8_t* bytes, const int32_t length) const;
    ...
    Vcu3_212::Vcu3_actualgearType vcu3_actualgear(const std::uint8_t* bytes, const int32_t length) const;
};
