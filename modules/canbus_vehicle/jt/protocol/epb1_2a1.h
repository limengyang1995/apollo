...
class Epb12a1 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::Jt> {
 public:
 ...
 private:
    ...
    int epb1_livecounter(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int epb1_epbswitch(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int epb1_epbstatus(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int epb1_checksum(const std::uint8_t* bytes, const int32_t length) const;
};
