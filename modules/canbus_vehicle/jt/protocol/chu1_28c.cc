...
Chu128c::Chu128c() {}
const int32_t Chu128c::ID = 0x28C;

void Chu128c::Parse(const std::uint8_t* bytes, int32_t length,
                         Jt* chassis) const {
  chassis->mutable_chu1_28c()->set_chu1_temperature(chu1_temperature(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_status(chu1_status(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_rechargerequest(chu1_rechargerequest(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_outputvoltage(chu1_outputvoltage(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_outputcurrent(chu1_outputcurrent(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_mode(chu1_mode(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_livecounter(chu1_livecounter(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_cpstatus(chu1_cpstatus(bytes, length));
  chassis->mutable_chu1_28c()->set_chu1_checksum(chu1_checksum(bytes, length));
}
...
int Chu128c::chu1_temperature(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 4);
...
int Chu128c::chu1_status(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
bool Chu128c::chu1_rechargerequest(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
int Chu128c::chu1_outputvoltage(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
...
double Chu128c::chu1_outputcurrent(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 2);
...
int Chu128c::chu1_mode(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
int Chu128c::chu1_livecounter(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
...
bool Chu128c::chu1_cpstatus(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
int Chu128c::chu1_checksum(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(0, 8);
