...
class Ur23b2 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::Jt> {
 public:
 ...
 private:
    ...
    int ur2_livecounter(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int ur2_distancevalue_rr(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int ur2_distancevalue_rmr(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int ur2_distancevalue_rml(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int ur2_distancevalue_rl(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int ur2_checksum(const std::uint8_t* bytes, const int32_t length) const;
};
