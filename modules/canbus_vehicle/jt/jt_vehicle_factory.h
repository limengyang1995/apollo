...
/**
 * @class JtVehicleFactory
 *
 * @brief this class is inherited from AbstractVehicleFactory. It can be used to
 * create controller and message manager for jt vehicle.
 */
class JtVehicleFactory : public AbstractVehicleFactory {
 public:
  /**
   * @brief destructor
   */
  virtual ~JtVehicleFactory() = default;
 ...
 private:
  /**
   * @brief create jt vehicle controller
  ...
  /**
   * @brief create jt message manager
   * @returns a unique_ptr that points to the created message manager
   */
  std::unique_ptr<MessageManager<::apollo::canbus::Jt>> CreateMessageManager();

  std::unique_ptr<::apollo::cyber::Node> node_ = nullptr;
  std::unique_ptr<apollo::drivers::canbus::CanClient> can_client_;
  CanSender<::apollo::canbus::Jt> can_sender_;
  apollo::drivers::canbus::CanReceiver<::apollo::canbus::Jt> can_receiver_;
  std::unique_ptr<MessageManager<::apollo::canbus::Jt>> message_manager_;
  std::unique_ptr<VehicleController<::apollo::canbus::Jt>> vehicle_controller_;
