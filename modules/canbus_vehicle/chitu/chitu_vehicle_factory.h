...
/**
 * @class ChituVehicleFactory
 *
 * @brief this class is inherited from AbstractVehicleFactory. It can be used to
 * create controller and message manager for chitu vehicle.
 */
class ChituVehicleFactory : public AbstractVehicleFactory {
 public:
  /**
   * @brief destructor
   */
  virtual ~ChituVehicleFactory() = default;
 ...
 private:
  /**
   * @brief create chitu vehicle controller
  ...
  /**
   * @brief create chitu message manager
   * @returns a unique_ptr that points to the created message manager
   */
  std::unique_ptr<MessageManager<::apollo::canbus::Chitu>> CreateMessageManager();

  std::unique_ptr<::apollo::cyber::Node> node_ = nullptr;
  std::unique_ptr<apollo::drivers::canbus::CanClient> can_client_;
  CanSender<::apollo::canbus::Chitu> can_sender_;
  apollo::drivers::canbus::CanReceiver<::apollo::canbus::Chitu> can_receiver_;
  std::unique_ptr<MessageManager<::apollo::canbus::Chitu>> message_manager_;
  std::unique_ptr<VehicleController<::apollo::canbus::Chitu>> vehicle_controller_;

  std::shared_ptr<::apollo::cyber::Writer<::apollo::canbus::Chitu>>
      chassis_detail_writer_;
  std::shared_ptr<::apollo::cyber::Writer<::apollo::canbus::Chitu>>
      chassis_detail_sender_writer_;
};

CYBER_REGISTER_VEHICLEFACTORY(ChituVehicleFactory)
