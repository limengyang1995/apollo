...
class ChituController final : public VehicleController<::apollo::canbus::Chitu> {
 public:

  ChituController() {};

  virtual ~ChituController();

  ::apollo::common::ErrorCode Init(
      const VehicleParameter& params,
      CanSender<::apollo::canbus::Chitu> *const can_sender,
      MessageManager<::apollo::canbus::Chitu> *const message_manager) override;
 ...
 private:
  // control protocol
  Adasanglecmd112* adas_angle_cmd_112_ = nullptr;
  Adasemergencyspot2a0* adas_emergency_spot_2a0_ = nullptr;
  Adasspeedcmd113* adas_speed_cmd_113_ = nullptr;
