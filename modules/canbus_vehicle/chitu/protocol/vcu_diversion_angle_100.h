...
class Vcudiversionangle100 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::Chitu> {
 public:
  static const int32_t ID;
  Vcudiversionangle100();
 ...
 private:
    ...
    double actual_steering_radian(const std::uint8_t* bytes, const int32_t length) const;
