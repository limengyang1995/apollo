...
class Vcumaxtemp4a1 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::Chitu> {
 public:
 ...
 private:
    ...
    int max_cell_temp(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int avrgcelltemp(const std::uint8_t* bytes, const int32_t length) const;
};
