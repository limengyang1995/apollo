...
class Vcuchargedischarge4a2 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::Chitu> {
 public:
  static const int32_t ID;
  Vcuchargedischarge4a2();
 ...
 private:
    ...
    Vcu_charge_discharge_4a2::Bms_statusType bms_status(const std::uint8_t* bytes, const int32_t length) const;
};
