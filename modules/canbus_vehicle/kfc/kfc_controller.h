...
class KfcController final : public VehicleController<::apollo::canbus::Kfc> {
 public:

  KfcController() {};

  virtual ~KfcController();

  ::apollo::common::ErrorCode Init(
      const VehicleParameter& params,
      CanSender<::apollo::canbus::Kfc> *const can_sender,
      MessageManager<::apollo::canbus::Kfc> *const message_manager) override;
