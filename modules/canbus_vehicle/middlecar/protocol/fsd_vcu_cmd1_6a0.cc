...
// public
Fsdvcucmd16a0::Fsdvcucmd16a0() { Reset(); }
...
void Fsdvcucmd16a0::Parse(const std::uint8_t* bytes, int32_t length,
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_tarvehrearangle(
    int fsd_vcu_tarvehrearangle) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_tarvehrearangle(uint8_t* data,
    int fsd_vcu_tarvehrearangle) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_brakepec(
    int fsd_vcu_brakepec) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_brakepec(uint8_t* data,
    int fsd_vcu_brakepec) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_cmdsource(
    Fsd_vcu_cmd1_6a0::Fsd_vcu_cmdsourceType fsd_vcu_cmdsource) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_cmdsource(uint8_t* data,
    Fsd_vcu_cmd1_6a0::Fsd_vcu_cmdsourceType fsd_vcu_cmdsource) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_specialmode(
...
void Fsdvcucmd16a0::set_p_fsd_vcu_specialmode(uint8_t* data,
    Fsd_vcu_cmd1_6a0::Fsd_vcu_specialmodeType fsd_vcu_specialmode) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_steermode(
    Fsd_vcu_cmd1_6a0::Fsd_vcu_steermodeType fsd_vcu_steermode) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_steermode(uint8_t* data,
    Fsd_vcu_cmd1_6a0::Fsd_vcu_steermodeType fsd_vcu_steermode) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_tarvehspeed(
    double fsd_vcu_tarvehspeed) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_tarvehspeed(uint8_t* data,
    double fsd_vcu_tarvehspeed) {
  fsd_vcu_tarvehspeed = ProtocolData::BoundedValue(0.0, 0.0, fsd_vcu_tarvehspeed);
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_tarvehfrontangle(
    int fsd_vcu_tarvehfrontangle) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_tarvehfrontangle(uint8_t* data,
    int fsd_vcu_tarvehfrontangle) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_maxvehspeedlmt(
    int fsd_vcu_maxvehspeedlmt) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_maxvehspeedlmt(uint8_t* data,
    int fsd_vcu_maxvehspeedlmt) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_emergstop(
    Fsd_vcu_cmd1_6a0::Fsd_vcu_emergstopType fsd_vcu_emergstop) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_emergstop(uint8_t* data,
    Fsd_vcu_cmd1_6a0::Fsd_vcu_emergstopType fsd_vcu_emergstop) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_targear(
    Fsd_vcu_cmd1_6a0::Fsd_vcu_targearType fsd_vcu_targear) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_targear(uint8_t* data,
    Fsd_vcu_cmd1_6a0::Fsd_vcu_targearType fsd_vcu_targear) {
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_park(
    Fsd_vcu_cmd1_6a0::Fsd_vcu_parkType fsd_vcu_park) {
...
void Fsdvcucmd16a0::set_p_fsd_vcu_park(uint8_t* data,
    Fsd_vcu_cmd1_6a0::Fsd_vcu_parkType fsd_vcu_park) {
  int x = fsd_vcu_park;
...
Fsdvcucmd16a0* Fsdvcucmd16a0::set_fsd_vcu_roulingcounter(
...
void Fsdvcucmd16a0::set_p_fsd_vcu_roulingcounter(uint8_t* data,
    int fsd_vcu_roulingcounter) {
...
Fsd_vcu_cmd1_6a0::Fsd_vcu_cmdsourceType Fsdvcucmd16a0::fsd_vcu_cmdsource(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
...
Fsd_vcu_cmd1_6a0::Fsd_vcu_specialmodeType Fsdvcucmd16a0::fsd_vcu_specialmode(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
...
Fsd_vcu_cmd1_6a0::Fsd_vcu_steermodeType Fsdvcucmd16a0::fsd_vcu_steermode(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
...
Fsd_vcu_cmd1_6a0::Fsd_vcu_emergstopType Fsdvcucmd16a0::fsd_vcu_emergstop(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 1);
